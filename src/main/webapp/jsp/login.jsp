...
<head>
    ...
    <script>
        ...
        function chgCode(){
            document.getElementById("img").src = "${pageContext.request.contextPath }/admin/createImg?xx="+Math.random();
        }
    </script>
</head>
<body style=" background: url(../img/19c1ecc67b41a7e29496eb83d4afa306.jpg); background-size: 100%;">
...
<div class="modal-dialog" style="margin-top: 10%;">
    <div class="modal-content">
        ...
        <form id="loginForm" method="post" action="${pageContext.request.contextPath }/admin/selectOne">
        <div class="modal-body" id = "model-body">
            ...
            <div class="form-group">
                ...
                <div class="col-sm-4">
                    <img id="img" src="${pageContext.request.contextPath }/admin/createImg" href="javascript:void(0)" onclick="chgCode()"/>
                </div>
            </div>
            <span id="msg"></span>
        </div>
